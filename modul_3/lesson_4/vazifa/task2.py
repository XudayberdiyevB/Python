"""
Mehmonxona registratsiya tizimini ishlab chiqing, bunda uning ismi, yoshi, qayerdan ekanligi va necha kun qolishligi,
 qancha pul to'lash kerak ekanligini ro'yxatga oling, ma'lumotlarni csv faylga saqlab boring.
"""
